...
def get_github_webhook_secret():
    try:
        parameter = ssm.get_parameter(Name='/ai-cq-pipeline/github-webhook-secret', WithDecryption=True)
...
def lambda_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    try:
        ...
        expected_signature = 'sha256=' + hmac_new(secret.encode('utf-8'), payload, digestmod='sha256').hexdigest()
